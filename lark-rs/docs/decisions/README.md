...
| [0020](0020-postlex-recovery-mirrors-resume-parse.md) | LALR recovery over a postlex (Indenter) hook — mirror Python's per-resume `Indenter.process` reset | Proposed |
