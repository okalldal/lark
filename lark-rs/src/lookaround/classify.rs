...
//! priority-entangled) lookahead, a
...
impl Rejection {
    ...
    pub fn scope(self) -> Scope {
        match self {
            ...
            // implemented. Leading unbounded lookaheads are now SUPPORTED (they do
...
mod tests {
    ...
    fn unbounded_lookahead_rejected() {
        // Leading unbounded lookaheads are now SUPPORTED (LeadingBoundary): the
